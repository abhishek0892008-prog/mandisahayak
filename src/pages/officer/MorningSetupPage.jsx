...
const getSeasonForDate = (dateValue) => {
...
const MorningSetupPage = ({
  ...
  const seasonName = getSeasonForDate(selectedDate || new Date());
              ...
              {dashboardStorage.map((crop) => {
                ...
                return (
                  <tr key={crop.crop}>
                    ...
                    <td className="px-3 py-2 text-slate-700">
                      {capacity.toLocaleString("en-IN")} kg
                    </td>
                    <td className="px-3 py-2 font-semibold text-slate-900">
                      {available.toLocaleString("en-IN")} kg
                    </td>
...
export default MorningSetupPage;
